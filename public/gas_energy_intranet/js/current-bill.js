...
var CurrentBillPageMainView = Backbone.View.extend({
	...
	drawGraph: function(obj) {
		...
		if (servObj !== undefined && servObj !== "" && !isNaN(servObj) &&	servObj >0) {
			sfcVal = parseFloat(servObj);
			if (sfcVal < 0)
				sfcVal = 0
		}
		console.log(elecVal);console.log(gascVal);console.log(sfcVal);
